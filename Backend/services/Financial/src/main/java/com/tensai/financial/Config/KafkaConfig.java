...
public class KafkaConfig {
    ...
    public static final String NOTIFICATION_TOPIC = "financial-notifications";
    ...
    // String-based producer configuration for PaymentService
    @Bean
    ...
    // Create payment notification topic
    @Bean
    ...
    // String-based consumer configuration
    @Bean
